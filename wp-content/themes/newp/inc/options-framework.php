...
function optionsframework_menu_settings() {
	...
	$menu = array(
		'page_title' => __( 'Newp Theme Options', 'optionsframework'),
		'menu_title' => __('Newp Settings', 'optionsframework'),
		'capability' => 'edit_theme_options',
		'menu_slug' => 'newp-options',
...
function optionsframework_load_scripts( $hook ) {
	...
	if ( !wp_script_is( 'wp-color-picker', 'registered' ) ) {
		wp_register_script( 'iris', OPTIONS_FRAMEWORK_DIRECTORY . 'js/iris.min.js', array( 'jquery','jquery-ui-draggable', 'jquery-ui-slider', 'jquery-touch-punch' ), false, 1 );
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'Newp Settings', 'options_framework_theme' ),
			'href' => admin_url( 'themes.php?page=newp-options' )
		));
}
