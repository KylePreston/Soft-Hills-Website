...
function optionsframework_options() {
	...
	$options[] = array(
		'desc' => __('To have more customization options including Favicon, Responsive Navigation Settings, etc. <a href="http://rohitink.com/product/coller-pro" target="_blank">Upgrade to Pro</a> at Just $14.95. Pro Version also supports customization of theme into unlimited colors. With Coller pro, you can design your own unique theme.'),
		'std' => '',
		'type' => 'info');		
		
	$options[] = array(
		'name' => __('Header Scripts', 'coller'),
		'desc' => __('Insert scripts or code before the closing &lt;/head&gt; tag in the document source. Please do not include Regular text in this section.', 'coller'),
		'id' => 'headcode1',
		'std' => '',
		'type' => 'textarea');
	
		$options[] = array(
		'name' => __('Custom Code in Footer', 'coller'),
		'desc' => __('Insert scripts or code before the closing &lt;/body&gt; tag in the document source:', 'coller'),
		'id' => 'footcode1',
		'std' => '',
		'type' => 'textarea');
	...
	$options[] = array(
		'desc' => __('To Customize the the slider with more settings like Transition Effect, Transition Duration, Adaptive Heights, Touch Enable on Touch Screen Devices, etc. <a href="http://rohitink.com/product/coller-pro" target="_blank">Upgrade to Pro</a> at Just $14.95'),
		'std' => '',
		'type' => 'info');
	...
	$options[] = array(
		'desc' => __('For More Social Icons. <a href="http://rohitink.com/product/coller-pro" target="_blank">Upgrade to Pro</a> at Just $14.95'),
		'std' => '',
		'type' => 'info');
	...
	$options[] = array(
		'desc' => __('Coller WordPress theme has been Designed and Created by <a href="http://rohitink.com" target="_blank">Rohit Tripathi</a>. For any Queries or help related to the theme you can <a href="http://rohitink.com/2013/09/11/coller-wordpress-theme/" target="_blank">comment on this page</a>. You can also ask questions about this theme on WordPress.org Support Forums. I will answer your queries there too.', 'coller'),
		'type' => 'info');	
			
	$options[] = array(
		'desc' => __('I offer Dedicated Personal e-mail support to all the Pro Version Customers. <a href="http://rohitink.com/product/coller-pro" target="_blank">Upgrade to Pro</a> at Just $14.95'),
		'std' => '',
		'type' => 'info');
